...
export const toggleTaskCompletion = async (req, res) => {
  ...
  logger.info(
    `Task toggled: ${taskId} (${task.completed ? 'completed' : 'pending'}) by user ${user.email}`
  );
...
export const deleteCompletedTasks = async (req, res) => {
  ...
  logger.info(
    `Deleted ${completedCount} completed tasks for user ${user.email}`
  );
...
export const completeAllTasks = async (req, res) => {
  ...
  logger.info(
    `Marked ${updatedCount} tasks as completed for user ${user.email}`
  );
